...
let searchInput, searchInputOld, categoryRadio, categoryRadioOld, resourceTypeRadio, resourceTypeRadioOld;
...
function search(searchData) {
    ...
    if (searchData.elementId === 'categoryRadio') {
        categoryRadio = searchData.value;
        categoryRadioOld = searchData.value;
    } else {
        categoryRadio = categoryRadioOld;
    }

    if (searchData.elementId === 'resourceTypeRadio') {
        resourceTypeRadio = searchData.value;
        resourceTypeRadioOld = searchData.value;
    } else {
        resourceTypeRadio = resourceTypeRadioOld;
    }
    ...
    console.log("Searching for searchInputOld : ", searchInputOld);
    console.log("Searching for categoryRadioOld : ", categoryRadioOld);
    console.log("Searching for resourceTypeRadioOld : ", resourceTypeRadioOld);
}
